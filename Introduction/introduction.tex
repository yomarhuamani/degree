...
\begin{spacing}{1.5}
	...
	En el tercer cap\'{i}tulo se desarrollan los requerisitos de software para la integraci\'[o]n del proyecto Saiku Analytics usando el marco de trabajo Scrum junto a la programaci\'[o] extrema como enfoque de desarrollo de software.\\
	Una de las características inherentes de todo proyecto son sus limitaciones y defectos, por tal motivo en el capítulo 4 indicamos nuestras conclusiones y recomendaciones obtenidas del trabajo de integración del proyecto Saiku Analytics.\\
