...
\begin{spacing}{1.5}	
	...
	En el proceso org\'{a}nico de su crecimiento Tesla Technologies S.A.C tiene conocimiento de las limitaciones de los reportes \textit{AdHoc} y su aporte en la elaboraci\'{o}n de informes gerenciales por parte de sus clientes. En consecuencia las limitaciones generan un significativo incremento de nuevos requerimientos para crear reportes Adhoc por cada cliente.\\
