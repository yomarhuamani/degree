...
\begin{spacing}{1.5}	
	...
	Existieron intentos de darle dinamismo y flexibilidad a los reportes solicitados, sin embargo los entregables m\'{i}nimos no cuplieron con las espectativas de la gerencia y los clientes, desarrollar una nueva aplicaci\'{o}n para atender esta necesidad tambi\'{e}n implicaba en riesgos de gestionar un nuevo proyecto y desatender objetivos estrat\'{e}gicos.\\
