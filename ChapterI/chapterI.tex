...
\begin{spacing}{1.5}	
	...
	\begin{figure}[H]
		\begin{center}
			\tikzI
		\end{center}
		\caption {\centering \small{Total de requisitos y requisitos para atender reportes}}
		\centering \small {Fuente: '{A}rea de soporte de Tesla Technologies S.A.C, 2016 - 2018} \label{figure:chaperI_1}
	\end{figure}
