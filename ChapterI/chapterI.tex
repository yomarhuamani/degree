...
\begin{spacing}{1.5}
	...
	\subsection{Aumentar la flexibilidad en la creaci\'{o}n de reportes.}
	\subsection{Controlar la cantidad de desarrollo de reportes a medida.}
	\subsection{Disminur el tiempo en desarrollo de reportes a medida.}
	\subsection{Disminuir el costo operativo en el desarrollo de reportes a medida.}
\end{spacing}
