...
\begin{spacing}{1.5}
	\begin{enumerate}[label=\alph*)]
		...
		\item Aumentar la flexibilidad de la creaci\'{o}n de reportes por parte de los usurios en la herramienta GiroSuite.
		\item Controlar la cantidad de desarrollo de reportes a medida para la herramienta GiroSuite.
		\item Disminur el tiempo en desarrollo de reportes a medida para la herramienta GiroSuite.
		\item Disminuir el costo operativo en el desarrollo de reportes a medida para la herramienta GiroSuite.
	\end{enumerate}	
\end{spacing}
