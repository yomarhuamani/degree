...
\section{Recomendaciones}
	...
	\begin{itemize}
		...
		\item No caer en el purismo de las metodolog\'{i}as tradicionales y las \'{a}giles; limitan la ejecuci\'{o}n de proyectos actuales, apostar por valores y principios en un equipo de trabajo sostiene a la continuidad de un proyecto.
