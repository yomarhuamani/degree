...
\begin{titlepage}
	 \begin{abstract}
		...
		En el camino de atender las necesidades de sus clientes y apoyarlos en la creación de informes gerenciales Tesla Technologies S.A.C decide integrar funcionalidades dinámicas de otros proyectos ya consolidados para lograr crear una ventaja comparativa a sus aplicaciones web comerciales.
		...
		Como resultado de la revisión a estas herramientas, fue el proyecto Saiku Analytics complemento de la suite Pentaho BI  que fue seleccionado por su facilidad y compatibilidad con las aplicaciones web comerciales de Tesla Technologies.
