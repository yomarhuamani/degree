...
\begin{spacing}{1.5}
	...
	En el primer \textit{Sprint} se tomaron 7 historias, como se muestra en la tabla \ref{table:III_1} \ref{table:III_1}. 
	...
	\subsection{\textit{Sprint BackLog}}
		...
		\begin{figure}[H]
			...
			\caption {\centering \small{Product BackLog}} \label{figure:chaperIII_3}
			\small {Fuente: \'{A}rea de desarrollo de Tesla Technologies S.A.C, 2018}
		\end{figure}
