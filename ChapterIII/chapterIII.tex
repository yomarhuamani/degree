...
\begin{spacing}{1.5}
	...
	Para establecer el trabajo que realizar\'{a} el \textit{Sprint}, el \textit{Scrum Team} debatio la propuesta del \textit{Product Owner} sobre integrar las funcionalidad core del proyecto Saiku Analytics manteniendo la compatibilidad del software GiroSuite con la infraestructura tecnol\'{o}gica de sus clientes; se priorizaron las siguientes historias.
		...
		\begin{enumerate}
			...
			\item \textbf{Verificar y corregir las librerias de conflicto para las especificaciones del servidor WebLogic 12c + y los archivos weblogic.xml y build.properties}
				\begin{itemize}
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=1 \textwidth]{saiku_10}
			...
			\item \textbf{Verificar y corregir librerias de conflicto para las especificaciones del servidor WebSphere 8.0+ y los archivos ibm-web-bnd.xml, ibm-web-ext.xml, deployment.xml y build.properties}
				\begin{itemize}
					...
					\begin{figure}[H]
						...
						\caption {\centering \small{GiroSuite y Rubik-report desplegado en WebSphere 9.0}} \label{figure:chaperIII_9}
						\small {Fuente: \'{A}rea de desarrollo de Tesla Technologies S.A.C, 2018}
					\end{figure}
