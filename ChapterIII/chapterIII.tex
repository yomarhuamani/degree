...
\begin{spacing}{1.5}
	...
	\subsection{\textit{Sprint Review}}
		...
		\begin{itemize}
			...
			\item Actualmente GiroSuite ya integrado con Rubik Report puede desplegar en las versiones Jbos EAP 6.4, 7.0 y sus versiones comunitarias Wildfly 10.0 Final, 10.1 y 11.0, ver Figura 
			\begin{figure}[H]
				\centering
				\includegraphics[width=1 \textwidth]{saiku_5}
				\caption {\centering \small{Proyecto Rubik-report integrado a GiroSuite}} \label{figure:chaperIII_7}
				\small {Fuente: \'{A}rea de desarrollo de Tesla Technologies S.A.C, 2018}
			\end{figure}
