...
\begin{spacing}{1.5}
	...
	\subsection{\textit{Sprint Review}}
		...
		\begin{itemize}
			\item En la verificaci\'{o}n de los clientes se encontraron conflictos con las version Jboss EAP 6.4, 7.0 y sus versiones comunitarias Wildfly 10.0 Final, 10.1 y 11.0.
