...
\begin{spacing}{1.5}
	...
	\subsection{\textit{Sprint Review}}
		...
		En la verificaci\'{o}n de los clientes se encontraron conflictos con las version Jbos EAP 6.4, 7.0 y sus versiones comunitarias Wildfly 10.0 Final, 10.1 y 11.0.
		
		Los conflictos son por configuraciones internas de librerias como jasper reports 3.0, implementaciones del standard JPA 1.0, librerias de JAX-WS.
		
		El equipo recomienda mantenerse en la JRS-366(Jdk 8) y eso debe comunicarse al equipo de ventas para no modificar esta especificaci\'{o}n.
