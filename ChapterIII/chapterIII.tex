...
\begin{spacing}{1.5}
	...
	Como parte de evaluaci\'{o}n, el \textit{Product Owner} otorgo la aprobaci\'{o}n con satisfacci\'{o}n luego de realizar sus pruebas de aceptaci\'{o}n de la entrega del increment.
