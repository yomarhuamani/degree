...
\section{Tecnolog\'{i}as BackEnd para la integraci\'{o}n del proyecto Saiku Analytics}
	...
	\clearpage
	\subsection{Mondrian}
			Mondrian es un motor OLAP escrito en Java. Ejecuta consultas escritas en lenguaje MDX, lee datos de una base de datos relacional (RDBMS) y presenta los resultados en un formato multidimensional a través de una API de Java. Veamos lo que eso significa.
			Acepta consultas analíticas y las convierte en consultas relacionales, devolviendo los datos en una forma compatible con la analítica. Pero para que Mondrian sea útil para los usuarios comerciales, necesita algún tipo de interfaz y aplicación para ejecutarlo.
