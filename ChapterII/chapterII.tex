...
\section{Programaci\'{o}n Extrema(XP)}
	...
	\subsection{Valores, Principios y Pr\'{a}cticas}
		...
		\begin{figure}[H]
			...
			\caption {\centering \small{Scrum Framework}} \label{figure:chaperII_2}
			\centering \small {Nota: Extraido de ``Extreme Programming Explained: Embrace Change, 2nd Edition", 2004}}
		\end{figure}
