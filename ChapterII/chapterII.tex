	...
	\subsection{Pr\'{a}cticas}
		\subsubsection{Pr\'{a}cticas primarias}
			\begin{enumerate}
				...
				\item \textit{Informative Workspace}\\
				\item \textit{Energized Work}\\
				\item \textit{Pair Programming}\\
				\item \textit{Pairing and Personal Space}\\
				\item \textit{Stories}\\
				\item \textit{Weekly Cycle}\\
				\item \textit{Quarterly Cycle}\\
				\item \textit{Slack}\\
				\item \textit{Ten-Minute Build}\\
				\item \textit{Continuous Integration}\\
				\item \textit{Test-First Programming}\\
