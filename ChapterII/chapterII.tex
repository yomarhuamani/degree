...
\section{Tecnolog\'{i}as FrontEnd para la integraci\'{o}n
	...
	\subsection{Node.js}
		...
		Node.js está diseñado sin subprocesos no significa que no pueda aprovechar múltiples núcleos en su entorno. Los procesos secundarios se pueden generar utilizando nuestra API child_process.fork () y están diseñados para que sea fácil comunicarse con ellos. Construido sobre esa misma interfaz está el módulo de clúster, que le permite compartir sockets entre procesos para permitir el equilibrio de carga en sus núcleos\cite{chap2_node}.
