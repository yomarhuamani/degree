...
\section{Saiku Analytics}
	...
	\subsubsection{Web-based Components}
		Son componentes basados ​​en la web de Pentaho para compartir soluciones de inteligencia empresarial mediante el an\'{a}lisis de datos, la creaci\'{o}n de informes y paneles integrados.
		\begin{enumerate}
			\item hi
		\end{enumerate}
