...
\section{Saiku Analytics}
	...
	Son componentes basados en la web de Pentaho creados para compartir soluciones de inteligencia empresarial mediante el a\'{a}lisis de datos la creaci\'{o}n de informes 
		\begin{enumerate}
			\item hi
		\end{enumerate}
