...
\section{Legalidad del software}
	...
	Es una licencia de software libre publicada por la Free Software Foundation que es una alternativas más permisiva que la estricta licencia copyleft GPL.
	LGPL solo requiere que los componentes derivados del elemento bajo LGPL continuen con esta licencia, y no el programa completo.
	LGPL es usado habitualmente para licencias de productos compartidos como por ejemplo librerías .dll, .so, .jar, etc.
