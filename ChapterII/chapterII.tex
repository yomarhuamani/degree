	...
	\subsection{Pr\'{a}cticas}
		\subsubsection{Pr\'{a}cticas primarias}
			\begin{enumerate}
				...
				Es fácil quitar valor a un proyecto de software; pero cuando estás cansado, es difícil reconocer que estás quitando valor.
