...
\section{Manifiesto por el Desarrollo \'{A}gil de software}
		\begin{figure}[H]
		\begin{center}
			\includegraphics[width=0.5 \textwidth]{manifiesto}
		\end{center}
		\caption {\centering \small{Manifiesto por el desarrollo \'{a}gil de software}} \label{figure:chaperII_16}
		\small {Fuente: ``Manifiesto \'{A}gil:" por Beck et al. ,2001 (\url {https://agilemanifesto.org/iso/es/manifesto.html}). Copyright 2001 por Manifiesto por el Desarrollo Ágil de Software}
		\end{figure}
