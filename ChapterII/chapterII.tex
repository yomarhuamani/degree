	...
	\subsection{Mondrian}
			...
			\begin{table}[bth]
				\begin{tabular}{@{}ll@{}}
					...
					\multicolumn{1}{|l|}{Pentaho Analyzer} & \multicolumn{1}{l|}{Pentaho’s enterprise analysis UI that provides interactive analysis with tables and graphs.} \\ \midrule
					\multicolumn{1}{|l|}{Pentaho Reporting} & \multicolumn{1}{l|}{A reporting tool that creates pixel-perfect reports using Mondrian data.} \\ \midrule
					\multicolumn{1}{|l|}{Community Dashboard Framework} & \multicolumn{1}{l|}{A popular open source dashboard framework for creating interactive dashboards.} \\ \midrule
					Saiku & A free open source analytics tool that provides interactive analysis with tables and graphs. Saiku is available as a Pentaho plugin or a standalone product. \\ \bottomrule
				\end{tabular}
			\end{table}
	\subsection{Git}
			\lipsum[1-2]
