...
\section{Open Source}
		...
		\begin{enumerate}[label=\alph*)]
			...
			\item Integridad del autor del c\'{o}digo fuente
			\item No discriminaci\'{o}n contra persona y grupos
			\item No discrininaci\'{o} en los lugares de actividad
			\item Licencia de distribuci\'{o}n
			\item La licencia no debe ser espec\'{i}fica para un producto
			\item La licencia no debe restringir a otro software
		\end{enumerate}
%------------------------------------------------------------------------------------------------------------------
%------------------------------------- Saiku Analytics ------------------------------------------------------------
%------------------------------------------------------------------------------------------------------------------	
