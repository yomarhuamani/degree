...
\section{Manifiesto por el Desarrollo \'{A}gil de software}
		...
		\small {Fuente: ``Manifiesto \'{A}gil:" por los firmantes del manifiesto (\url {https://agilemanifesto.org/iso/es/manifesto.html)}, 2001 Copyright by los firmantes del manifiesto}
		\end{figure}
