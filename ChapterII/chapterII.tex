...
\section{SCRUM}
	...
	\subsection{\textit{Scrum Team}}
		...
		\subsubsection{Developers}
			Son Las personas del Scrum Team que se comprometen a crear cualquier aspecto de un Increment utilizable	en cada Sprint son Developers.
			...
			\begin{enumerate}[-]
				\item Crear un plan para el Sprint, el Sprint Backlog;
				\item Inculcar calidad al adherirse a una Definición de Terminado;
				\item Adaptar su plan cada día hacia el Objetivo del Sprint; y,
