...
\section{Saiku Analytics}
	...
	Son componentes basados ​​en la web de Pentaho para compartir soluciones de inteligencia empresarial mediante el análisis de datos, la creación de informes y la creación de paneles integrados.
		\begin{enumerate}
			\item hi
		\end{enumerate}
