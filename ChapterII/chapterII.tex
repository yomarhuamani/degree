...
\section{Tecnolog\'{i}as BackEnd para la integraci\'{o}n del proyecto Saiku Analytics}
	...
	\subsection{Mondrian}
			...
			\tiny  {Fuente: ``Mondrian in Action" por D., William Back and Goodman, Nicholas and Hyde, Julian, 2013, Copyright by Manning Publications Co.}
			\label{table:1}
			\end{table}
		
		La figura 2.1 muestra cómo Mondrian encaja en la arquitectura de Pentaho. Esta vista está muy simplificada, pero contiene las partes principales de un sistema que usa Mondrian.
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.5 \textwidth]{mondrian_1}
