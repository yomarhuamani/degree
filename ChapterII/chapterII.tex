...
\section{Programaci\'{o}n Extrema(XP)}
	...
	\subsection{Pruebas}
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=0.5 \textwidth]{xp_6}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.5 \textwidth]{xp_7}
