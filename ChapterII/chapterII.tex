...
\section{Manifiesto por el Desarrollo \'{A}gil de software}
		\begin{figure}[H]
		\centering
		\includegraphics[width=0.1 \textwidth]{manifiesto}
		\caption {\centering \small{Manifiesto por el desarrollo \'{a}gil de software}} \label{figure:chaperII_16}
		\small {Fuente: ``Manifiesto \'{A}gil:" por los firmantes del manifiesto (https://agilemanifesto.org/iso/es/manifesto.html), 2001 Copyright by los firmantes del manifiesto}
		\end{figure}
