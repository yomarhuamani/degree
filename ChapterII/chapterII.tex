...
\section{Tecnolog\'{i}as FrontEnd para la integraci\'{o}n
	...
	\subsection{ECMAScript5 (ES5)}
		...
		\begin{itemize}
			...
			\item Soporte para el formato de codificación de objetos JSON, y un modo estricto que proporciona una comprobación de errores mejorada y seguridad del programa.
		\end{itemize}
		...
		soporte para el formato de codificación de objetos JSON, y
		un modo estricto que proporciona una comprobación de errores mejorada y seguridad del programa.
	\subsection{HTML5}
			\lipsum[1-2]
