...
\section{SCRUM}
	\subsection{Definici\'{o}n de Scrum}
		...
		\begin{enumerate}
			\item Un \textit{Product Owner} ordena el trabajo de un problema complejo en un Product Backlog.
			\item El \textit{Scrum Team} convierte una selección del trabajo en un Increment de valor durante un Sprint.
			\item El \textit{Scrum Team} y sus interesados inspeccionan los resultados y se adaptan para el próximo
			Sprint.
			\item Repita
		\end{enumerate}
		...
		Scrum guían sus relaciones e interacciones \cite{chap2_scrum}.\\
		...
		actuales de gestión, entorno y trabajo, de modo que se puedan realizar mejoras \cite{chap2_scrum}.
