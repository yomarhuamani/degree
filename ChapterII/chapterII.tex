...
\section{SCRUM}
	...
	\subsection{Artefactos de Scrum}
		...
		\subsubsection{\textit{Product Backlog}}
			...
			El Objetivo del Producto describe un estado futuro del producto que puede servir como un objetivo para que el \textit{Scrum Team} planifique. El Objetivo del Producto está en el \textit{Product Backlog}. El resto del Product Backlog emerge para definir "qué" cumplirá con el Objetivo del Producto.
